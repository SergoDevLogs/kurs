...
<h2>Остатки в магазине: <?= $_SESSION['user_establishment'] ?></h2>
...
<div class="card mb-4">
    <div class="card-body">
        ...
        <input type="hidden" name="sort" id="sortField" value="<?= $_GET['sort'] ?? 'product_name' ?>">
        <input type="hidden" name="order" id="sortOrder" value="<?= $_GET['order'] ?? 'ASC' ?>">
...
<div class="table-responsive">
    <table class="table table-striped table-hover">
        ...
        <tbody id="tableBody">
            <?php include __DIR__ . '/../partials/cashier_stocks_table.php'; ?>
        </tbody>
    </table>
</div>
